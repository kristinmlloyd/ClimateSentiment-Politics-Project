...
train_df = pd.read_csv("../Data/raw-data/hi5.csv")
...
senators_df = pd.read_csv("../Data/processed-data/senators1.csv")
...
# Create a DataFrame to hold the original data and model predictions
final_df = pd.concat([senators_df, pd.DataFrame({col: senators_df[col] for col in prediction_columns})], axis=1)

# Add a new column for the model's label
final_df['model_labelling'] = final_df[prediction_columns].mode(axis=1)

# Save the final DataFrame to a CSV file
final_df.to_csv("Senators_predictions_with_labels1.csv", index=False)
