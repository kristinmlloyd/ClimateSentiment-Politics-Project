...
df.to_csv("../Data/processed-data/predictions.csv", index=False)

```

```{python}

df = pd.read_csv("../Data/processed-data/predictions.csv")
...
Save as two separate datasets, one for the president and one for the senators.
...
# Split the dataset into President and Senators based on the 'state' column
president_df = df[df['state'] == 'US']
senators_df = df[df['state'] != 'US']

# Save the filtered datasets to separate CSV files
president_df.to_csv("../Data/processed-data/President_predictions.csv", index=False)
senators_df.to_csv("../Data/processed-data/Senators_predictions.csv", index=False)

print("President predictions saved to President_predictions.csv")
print("Senators predictions saved to Senators_predictions.csv")
